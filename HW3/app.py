...
def message_text(event):
    sentiment_result, confidence_scores = azure_sentiment(event.message.text)
...
# 提取 mined_opinions
        for opinion in doc.sentences[0].mined_opinions:
            ...
            print(f"Opinion Target: {target_text}")
...
# # 将情感结果转换为中文描述
    ...
    if sentiment_result == "positive":
        return "正向", confidence_scores
    elif sentiment_result == "negative":
        return "负向", confidence_scores
    else:
        return "中立", confidence_scores
